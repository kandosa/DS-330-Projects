...
iplot(fig1, filename='erangle solo')
```


<div id="493522be-747b-48e4-ba0e-4b61a008a422" style="height: 525px; width: 100%;" class="plotly-graph-div"></div><script type="text/javascript">require(["plotly"], function(Plotly) { window.PLOTLYENV=window.PLOTLYENV || {};window.PLOTLYENV.BASE_URL="https://plot.ly";Plotly.newPlot("493522be-747b-48e4-ba0e-4b61a008a422", [{"name": "erangle top 5 solo", "x": ["kills", "damage", "number of player knocked", "survive time"], "y": [3.802782677772456, 411.6037468409637, 0.0, 30.432280752691106], "type": "bar", "uid": "4991d3dd-0269-47a7-95b5-e4927f61e40e"}, {"name": "erangle solo", "x": ["kills", "damage", "number of player knocked", "survive time"], "y": [0.716783078248595, 93.67493624280584, 0.0, 10.868979388918422], "type": "bar", "uid": "115dba8e-f1d7-4a8b-9f6c-61280035824f"}], {"barmode": "group"}, {"showLink": true, "linkText": "Export to plot.ly", "plotlyServerURL": "https://plot.ly"})});</script><script type="text/javascript">window.addEventListener("resize", function(){window._Plotly.Plots.resize(document.getElementById("493522be-747b-48e4-ba0e-4b61a008a422"));});</script>



```python
#making barchart for erangle top&rest duo
trace11 = go.Bar(
    x=['kills', 'damage', 'number of player knocked', 'survive time'],
...
iplot(fig2, filename='erangle duo stats')
```


<div id="8c63d561-71e1-4c6e-89ed-6b443b290839" style="height: 525px; width: 100%;" class="plotly-graph-div"></div><script type="text/javascript">require(["plotly"], function(Plotly) { window.PLOTLYENV=window.PLOTLYENV || {};window.PLOTLYENV.BASE_URL="https://plot.ly";Plotly.newPlot("8c63d561-71e1-4c6e-89ed-6b443b290839", [{"name": "erangle top 5 duo", "x": ["kills", "damage", "number of player knocked", "survive time"], "y": [2.6192155389195597, 314.99098581852866, 1.3590786904802572, 28.350402664226458], "type": "bar", "uid": "d56b1a25-5348-4e8f-ac6a-863d91584ee4"}, {"name": "erangle duo", "x": ["kills", "damage", "number of player knocked", "survive time"], "y": [0.6731185238244994, 99.803011322684, 0.48505195416077895, 10.618317072441641], "type": "bar", "uid": "cc906eae-21b0-4a2d-ab80-2a9ccea6490d"}], {"barmode": "group"}, {"showLink": true, "linkText": "Export to plot.ly", "plotlyServerURL": "https://plot.ly"})});</script><script type="text/javascript">window.addEventListener("resize", function(){window._Plotly.Plots.resize(document.getElementById("8c63d561-71e1-4c6e-89ed-6b443b290839"));});</script>
...
<div id="060571fe-ac2d-4736-b18b-bb3a2ad7cef0" style="height: 525px; width: 100%;" class="plotly-graph-div"></div><script type="text/javascript">require(["plotly"], function(Plotly) { window.PLOTLYENV=window.PLOTLYENV || {};window.PLOTLYENV.BASE_URL="https://plot.ly";Plotly.newPlot("060571fe-ac2d-4736-b18b-bb3a2ad7cef0", [{"name": "miramar top 5 solo", "x": ["kills", "damage", "number of player knocked", "survive time"], "y": [3.5243644911945173, 389.93429755358994, 0.0, 30.13379038203575], "type": "bar", "uid": "499078d6-8940-4d27-be6f-f1a60ab0db25"}, {"name": "miramar solo", "x": ["kills", "damage", "number of player knocked", "survive time"], "y": [0.7068443183421989, 93.57659373068519, 0.0, 10.506427771295566], "type": "bar", "uid": "20482c38-0214-4285-8a53-2752ec90f9bf"}], {"barmode": "group"}, {"showLink": true, "linkText": "Export to plot.ly", "plotlyServerURL": "https://plot.ly"})});</script><script type="text/javascript">window.addEventListener("resize", function(){window._Plotly.Plots.resize(document.getElementById("060571fe-ac2d-4736-b18b-bb3a2ad7cef0"));});</script>



```python
#making barchart for mir top&rest duo
trace41 = go.Bar(
    x=['kills', 'damage', 'number of player knocked', 'survive time'],
...
iplot(fig5, filename='miramar duo stats')
```


<div id="9892ce6c-f03a-4d18-8aa0-51bb5f6221af" style="height: 525px; width: 100%;" class="plotly-graph-div"></div><script type="text/javascript">require(["plotly"], function(Plotly) { window.PLOTLYENV=window.PLOTLYENV || {};window.PLOTLYENV.BASE_URL="https://plot.ly";Plotly.newPlot("9892ce6c-f03a-4d18-8aa0-51bb5f6221af", [{"name": "miramar top 5 duo", "x": ["kills", "damage", "number of player knocked", "survive time"], "y": [2.4238038066100693, 298.8477477861814, 1.2745196028839063, 27.9620662412722], "type": "bar", "uid": "6ff17b21-9900-4914-b126-3e0f1e82330e"}, {"name": "miramar duo", "x": ["kills", "damage", "number of player knocked", "survive time"], "y": [0.6668025312039079, 99.23229584635148, 0.487672275704566, 10.218438167005008], "type": "bar", "uid": "38441864-529f-4e58-861a-3217be9b07e9"}], {"barmode": "group"}, {"showLink": true, "linkText": "Export to plot.ly", "plotlyServerURL": "https://plot.ly"})});</script><script type="text/javascript">window.addEventListener("resize", function(){window._Plotly.Plots.resize(document.getElementById("9892ce6c-f03a-4d18-8aa0-51bb5f6221af"));});</script>



```python
#making barchart for mir top&rest squad
trace51 = go.Bar(
    x=['kills', 'damage', 'number of player knocked', 'survive time'],
